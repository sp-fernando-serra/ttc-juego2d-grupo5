...
DefaultProperties
{
	...
	Begin Object class=SkeletalMeshComponent Name=InitialPawnSkeletalMesh
		...
		AnimSets(0)=AnimSet'Betty_plantas.SkModels.plantaRio_Anims'
		AnimTreeTemplate=AnimTree'Betty_plantas.SkModels.plantaRio_AnimTree'
		PhysicsAsset=PhysicsAsset'Betty_plantas.SkModels.plantaRio_Physics'
		SkeletalMesh=SkeletalMesh'Betty_plantas.SkModels.plantaRio'
